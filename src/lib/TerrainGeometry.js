...
export function buildTerrainGeometry(size, boxHeight, segments) {
    ...
    addVertex(-halfSize, bottomY, -halfSize, 0, -1, 0);
    addVertex( halfSize, bottomY, -halfSize, 0, -1, 0);
    indices[iIdx++] = bottomOffset; indices[iIdx++] = bottomOffset + 1; indices[iIdx++] = bottomOffset + 2;
    indices[iIdx++] = bottomOffset + 1; indices[iIdx++] = bottomOffset + 3; indices[iIdx++] = bottomOffset + 2;
    ...
    const buildWall = (isX, isPositive, nx, ny, nz) => {
        ...
        for (let i = 0; i < segments; i++) {
            ...
            if (needsABD) {
                ...
                indices[iIdx++] = a; indices[iIdx++] = d; indices[iIdx++] = b;
